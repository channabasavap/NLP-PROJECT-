...
def main():
    ...
    tfidf = pickle.load(open('C:\\Users\\chann\\OneDrive\\Desktop\\predicated model\\model_sentiment_tfidf123 (1).pkl', 'rb'))
    # Load final model
    model = pickle.load(open('C:\\Users\\chann\\OneDrive\\Desktop\\predicated model\\model_sentiment123 (1).pkl', 'rb'))
